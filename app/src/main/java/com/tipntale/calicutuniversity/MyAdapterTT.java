...
public class MyAdapterTT extends RecyclerView.Adapter<MyAdapterTT.ViewHolder> {
    private List<ListItemTT> listItems;
    private Context context;

    public MyAdapterTT(List<ListItemTT> listItems, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.ttlist_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final ListItemTT listItem = listItems.get(position);
        ...
        holder.timetableitem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                if(listItem.getTitle().toString().equals("Time-tables are shown here once they get loaded"))
                {}
                else if(listItem.getTitle().toString().equals("No data available"))
                {}
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            timetableitem = (LinearLayout) itemView.findViewById(R.id.timetable_item);
